...
__all__ = ['OLD2NEW_LABELS_DICT', 'OLD_LABELS', 'NEW_LABELS', 'OLD_LABELS_TO_IDX', 'NEW_LABELS_TO_IDX',
           ...
           'BEN_20m_CHANNELS', 'BEN_10m_20m_CHANNELS', 'BEN_30m_CHANNELS', 'BEN_RGB_CHANNELS', 'COUNTRIES',
           'COUNTRIES_ISO_A2', 'BEN_COMPLETE_SIZE', 'BEN_SNOWY_PATCHES_COUNT', 'BEN_CLOUDY_OR_SHADOWY_PATCHES_COUNT',
           'BEN_NO_19_CLASS_TARGET_COUNT', 'BEN_RECOMMENDED_SIZE', 'print_all_constants']
